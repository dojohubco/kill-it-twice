...
After the historical report above, [run 35148507444](https://github.com/dojohubco/kill-it-twice/actions/runs/35148507444) completed successfully at documentation HEAD 642925bf66fc0755f4a845bab2a55350957475c4 (2026-09-16 20:45:53–20:47:22 UTC). M2C intake independently checked its read-only run metadata. The reviewer inspected code and the hosted artifact (reported SHA-256 b13b7681199201c1f0d445ddc4d266cee09fa4c951abe4cfc8b0dac5c8ce29f2), including 30 unit checks and 22/36/16/16 profile results. Their offline check reconciled 40 staged events per M2B snapshot to source exports, bytes/hashes, metadata, two intents and one observation. This is artifact inspection, not a reviewer-local PostgreSQL rerun or full-scale reconciliation. The old NOT RUN statement preserves its original timing. No M2C or full G1–G5 result follows.

Chronology clarification: M2B's descriptive required-case design was committed at 9231de2 before production changes; its executable inventory was present before developmental execution and committed with tests at 968be23 after initial dirty runs. ADR 008's original wording “committed before execution” referred too broadly to the inventory. The actual distinction is retained here rather than inventing a test-first commit history.
