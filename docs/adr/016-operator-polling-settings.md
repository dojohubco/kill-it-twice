...
Date: 2026-09-25. Status: accepted for the user-authorized completion of UI parameter editing and public GitHub publication; implementation and fresh verification pending.
